...
export const commentsToOfferN1: Comment[] = [];

export const commentsToOfferN2: Comment[] = [
  {
    id: 1,
    user: {
      id: 18,
...
export const commentsToOfferN3: Comment[] = [
  {
    id: 1,
    user: {
      id: 18,
...
export const commentsToOfferN4: Comment[] = [
  {
    id: 1,
    user: {
      id: 17,
